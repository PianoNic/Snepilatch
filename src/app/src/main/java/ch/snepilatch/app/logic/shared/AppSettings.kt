...
/**
 * Process-scoped store for the persisted user settings (like [ch.snepilatch.app.logic.shared.SessionHolder]
...
object AppSettings {
    ...
    // [SOURCE_YTM] = YouTube Music (ch.snepilatch.app.logic.playback.YouTubeMusicSource).
    ...
    val eqBands = MutableStateFlow(FloatArray(ch.snepilatch.app.logic.playback.EqualizerHeadroom.BANDS))
    ...
    private fun parseBands(raw: String?): FloatArray {
        val bands = ch.snepilatch.app.logic.playback.EqualizerHeadroom.BANDS
