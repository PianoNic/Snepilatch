...
class SpotifyStore {
  ...
  // Library state
  final ValueNotifier<List<LibraryItem>> libraryItems = ValueNotifier([]);
  final ValueNotifier<bool> isLoadingLibrary = ValueNotifier(false);
  ...
  void dispose() {
    ...
    libraryItems.dispose();
    isLoadingLibrary.dispose();
